...
class Institute(models.Model):
    ...
    institutewebsite = models.CharField(db_column='InstituteWebsite', max_length=255)  # Field name made lowercase.
    password = models.CharField(db_column='Password', max_length=255)  # Field name made lowercase.
    registrationapproved = models.BooleanField(db_column='RegistrationApproved')  # Field name made lowercase.
...
class Instruments(models.Model):
    id = models.CharField(db_column='IID', primary_key=True, max_length=10)  # Field name made lowercase.
    ...
    class Meta:
        ...
        # exclude = ('id',)
        # import_id_fields = ('iid', 'instrumentname', 'category', 'instrumentquantity', 'instrumentdescription', 'institute')
